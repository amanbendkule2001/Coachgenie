                    ...
                    <div key={e.id} className="page-card">
                        <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                            ...
                            <div className="flex items-center gap-1.5">
                                <a href={`tel:${e.phone}`} title="Call enquiry" aria-label="Call enquiry" className="p-2 rounded-xl bg-success-50 text-success-600 hover:bg-success-100"><Phone size={14} /></a>
                                <a href={`mailto:${e.email}`} title="Email enquiry" aria-label="Email enquiry" className="p-2 rounded-xl bg-primary-50 text-primary-600 hover:bg-primary-100"><Mail size={14} /></a>
                                <button onClick={() => openEdit(e)} title="Edit enquiry" aria-label="Edit enquiry" className="p-2 rounded-xl hover:bg-surface-muted"><Pencil size={14} /></button>
                                <button onClick={() => setDeleteId(e.id)} title="Delete enquiry" aria-label="Delete enquiry" className="p-2 rounded-xl hover:bg-danger-50"><Trash2 size={14} /></button>
                            </div>
                        </div>
